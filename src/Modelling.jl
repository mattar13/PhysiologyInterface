...
# ╔═╡ 4b385ee4-0ffb-47c8-832c-2de03eee7fd0
begin
	@parameters t K1
	@variables A(t)
	D = Differential(t)
...
# ╔═╡ b6413d4c-2c28-42dd-b74a-20d3bb3860d2
@connector function cable(; name)
	
	
end

# ╔═╡ 2e463045-a0b2-4ecf-a7d5-0ae29e6273c3
begin
	rxn_net = @reaction_network begin
		K2*A, 0-->B
	end
	REACTIONS = convert(ODESystem, rxn_net)
end

# ╔═╡ a8458dd0-8f4f-4b06-82f6-d56a94b67d6d
begin
	eqns = [
		D(A) ~ -K1*A		
	]
...
# ╔═╡ e113a765-30fe-4647-bc35-9dc094f796fc
@named connected = compose(
	ODESystem([REACTIONS.A ~ VOLTAGES.A], t; name = :test)
)

# ╔═╡ e075926f-17f1-426a-a710-68f7e762852b
connected |> typeof |> fieldnames

# ╔═╡ 8b8877a9-0775-48d7-99c8-b7efa4261e70
connected.states

# ╔═╡ 680cc93c-f380-4e79-9171-290c2f73c701
@component function OS(; name)
	...
	connected = compose(
		ODESystem([REACTIONS.A ~ VOLTAGES.A], t; name = name)
	)
	simplified_sys = structural_simplify(connected)
	return simplified_sys
end

# ╔═╡ 1c5bbe00-baa6-42c1-8890-5e2ea42bca1f
@named eqn = OS(name = :OS);

# ╔═╡ 4cd20976-cf51-4981-b901-11d2e91bf366
...
# ╔═╡ 0274878c-24d3-429d-a8ea-0b991b68268c
p0 = [
...
# ╔═╡ 416a0208-518d-4f19-9619-d2b9fca3029a


# ╔═╡ 9c9c284b-2c7d-4645-8fc8-9fc0febd27c1
@connector function Dendrite(; name = :Dendrite)
...
git-tree-sha1 = "413ee74c986269c12a734558a36e243c7c7b98a9"
...
deps = ["Dates", "Polynomials", "Statistics"]
git-tree-sha1 = "9daf3a937d9b28ef1aaa95f13026e4536458506b"
