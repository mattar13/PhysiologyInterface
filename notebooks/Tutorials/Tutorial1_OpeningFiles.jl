...
# ╔═╡ 2fe00920-469f-11ee-154e-8b94cd44e405
begin
...
# ╔═╡ 7331d857-4621-4941-9fef-bb55966c595d
path = raw"C:\Users\mtarc\.julia\dev\PhysiologyInterface\test\to_analyze.abf"

# ╔═╡ 5eb9d24d-28e6-4123-8bd8-15df4e4a3eff
data = readABF(path) |> data_filter

# ╔═╡ 6630b793-ef96-4ce0-8168-8eb0cb8ce9a9
...
[compat]
ElectroPhysiology = "~0.4.10"
PhysiologyPlotting = "~0.1.4"
PyPlot = "~2.11.2"
"""
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "bca10318bde9c1e7aaf32a281c2037a99e646e7e"
...
git-tree-sha1 = "c2376f714deff77f368b6282bf157ba99eb0187c"
...
deps = ["CairoMakie", "Conda", "DataFrames", "ElectroPhysiology", "Pkg", "PyCall", "PyPlot", "Query", "Requires"]
git-tree-sha1 = "e8182e003f07bcc12c5ba5eec9c23f8c0e13413c"
