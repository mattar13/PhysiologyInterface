...
begin
	...
	import PhysiologyPlotting.PyPlot as plt
end
...
begin
	...
	dataset = runTraceAnalysis(dataset, verbose = false);
	#dataset["TRACES"] = dataset["TRACES"] |> @filter(_.Channels ∈ channels) |> DataFrame
...
[compat]
DataFrames = "~1.6.0"
ElectroPhysiology = "~0.4.7"
PhysiologyAnalysis = "~0.6.8"
PhysiologyPlotting = "~0.1.2"
PlutoUI = "~0.7.51"
Query = "~1.0.0"
XLSX = "~0.9.0"
"""
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "0c03de283825ff43380545e35aaa8865ce5384c6"
...
deps = ["ContinuousWavelets", "DSP", "DataFrames", "Dates", "Documenter", "Polynomials", "Statistics", "Wavelets", "XLSX"]
git-tree-sha1 = "b27ef7ddd1943875a6375af33af133c200750e74"
...
deps = ["CSV", "DataFrames", "Dates", "ElectroPhysiology", "HypothesisTests", "LsqFit", "ModelingToolkit", "OrdinaryDiffEq", "Polynomials", "Query", "Requires", "Statistics", "StatsBase", "Test", "XLSX"]
git-tree-sha1 = "c0c6d8fa3ee6c6c7dd432f4fa27a624be9729b19"
uuid = "69cbc4a0-077e-48a7-9b45-fa8b7014b5ca"
version = "0.6.8"

[[deps.PhysiologyPlotting]]
deps = ["ElectroPhysiology", "Plots", "PyCall", "PyPlot"]
git-tree-sha1 = "34d9d8549fddafcc94aa63cbcf12d921270c65cf"
